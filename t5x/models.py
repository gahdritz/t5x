...
def compute_base_metrics(
  ...
  metrics = {
      ...
      'loss':
          metrics_lib.AveragePerStep.from_model_output(loss),
  ...
  if z_loss is not None:
    metrics.update({
        'z_loss':
            metrics_lib.AveragePerStep.from_model_output(z_loss),
        'z_loss_per_all_target_tokens':
            clu_metrics.Average(total=z_loss, count=num_tokens),
        'cross_ent_loss':
            metrics_lib.AveragePerStep.from_model_output(loss - z_loss),
